...
//
// Debug information:
// Generated date: Thu Jul 05 03:40:44 UTC 2018
...
public class employees extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("employeeNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.employeeNumber = (Integer)value;
      }
    });
    setters.put("lastName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.lastName = (String)value;
      }
    });
    setters.put("firstName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.firstName = (String)value;
      }
    });
    setters.put("extension", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.extension = (String)value;
      }
    });
    setters.put("email", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.email = (String)value;
      }
    });
    setters.put("officeCode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.officeCode = (String)value;
      }
    });
    setters.put("reportsTo", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.reportsTo = (Integer)value;
      }
    });
    setters.put("jobTitle", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employees.this.jobTitle = (String)value;
      }
    });
  }
  public employees() {
