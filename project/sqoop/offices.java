...
//
// Debug information:
// Generated date: Thu Jul 05 03:50:45 UTC 2018
  ...
  private void init0() {
    setters.put("officeCode", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        offices.this.officeCode = (String)value;
      }
    });
    ...
    setters.put("phone", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.phone = (String)value;
      }
    });
    setters.put("addressLine1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.addressLine1 = (String)value;
      }
    });
    setters.put("addressLine2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.addressLine2 = (String)value;
      }
    });
    setters.put("state", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.state = (String)value;
      }
    });
    setters.put("country", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.country = (String)value;
      }
    });
    setters.put("postalCode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.postalCode = (String)value;
      }
    });
    setters.put("territory", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        offices.this.territory = (String)value;
      }
    });
  }
  public offices() {
